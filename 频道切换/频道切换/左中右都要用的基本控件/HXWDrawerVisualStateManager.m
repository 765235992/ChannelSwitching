...
@implementation HXWDrawerVisualStateManager
+ (HXWDrawerVisualStateManager *)sharedManager {
    static HXWDrawerVisualStateManager *_sharedManager = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _sharedManager = [[HXWDrawerVisualStateManager alloc] init];
